                    ...
                    <div className='lado-esquerdo'>
                        <div className='texto-titulo-botao'>
                            ...
                            <div className='paragrafo'>
                                ...
                                ,uma plataforma SaaS inovadora para a gestão de atendimentos, criada para atender profissionais do 
                                setor de beleza e autônomos em geral. Ideal para salões, barbearias, estúdios de estética e
                                 qualquer prestador de serviços com agendamento prévio, seja pessoa física ou jurídica. 
                                 A QuedMark facilita o agendamento,
                                 organização e acompanhamento de serviços, proporcionando uma experiência prática e eficiente para todos.
